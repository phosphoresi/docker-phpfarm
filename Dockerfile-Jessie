...
ENV PHP_FARM_VERSIONS="5.3.29 5.4.45 5.5.38 5.6.31 7.0.23 7.1.9 7.2.0RC2" \
  \
...
RUN apt-get update && \
  ...
  \
  # Download PhpFarm v0.2.0 scripts into /phpfarm/.
...
# expose the ports
EXPOSE 8053 8054 8055 8056 8070 8071 8072
